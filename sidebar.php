...
<div class="sidebar">
  <a href="dashboard.php" class="<?php active_link('dashboard.php');?>"><i class="fa fa-home"></i> Dashboard</a>
  ...
  <a href="laporan_pajak.php" class="<?php active_link('laporan_pajak.php');?>"><i class="fa fa-money"></i> Laporan Pajak</a>
